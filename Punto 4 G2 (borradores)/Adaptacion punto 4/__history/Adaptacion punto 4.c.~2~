...
/*Realizar una rutina que permita leer el número ingresado en un teclado matricial, sin
utilizar ninguna librería con el objetivo de hacer uso del puerto B para la lectura del mismo,
mostrar el número o carácter en un display lcd conectado al puerto A.*/
